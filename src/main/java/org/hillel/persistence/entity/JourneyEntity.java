...
//            throw new IllegalArgumentException("JourneyEntity.constructor route not valid");
//        if (Objects.isNull(stationFrom) || !trip.isValid())
//            throw new IllegalArgumentException("JourneyEntity.constructor stationFrom not valid");
//        if (Objects.isNull(stationTo) || !trip.isValid())
//            throw new IllegalArgumentException("JourneyEntity.constructor stationTo not valid");
//
...
//        return stationFrom.isValid() && stationTo.isValid() && departure != null && arrival != null;
        return stationFrom.length()>3 && stationTo.length() >3 && departure != null && arrival != null;
    }
