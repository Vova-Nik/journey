...
public class StationSpecification {
    public static Specification<StationEntity> filtered(QueryParam param) {
    ...
    public static Specification<StationEntity> byQueryParam(QueryParam param) {
        return new Specification<StationEntity>() {
            @Override
            public Predicate toPredicate(@NonNull Root<StationEntity> root,
